...
import com.application.zimply.adapters.CompleteCategoryRecyclerAdapter;
import com.application.zimply.adapters.CompleteCategoryRecyclerAdapter.OnItemClickListener;
import com.application.zimply.adapters.CompleteSubCategoryRecyclerGridAdapter;
import com.application.zimply.adapters.CompleteSubCategoryRecyclerGridAdapter.SubCatOnItemClickListener;
import com.application.zimply.adapters.CompleteSubSubCategoryAdapter;
import com.application.zimply.adapters.CompleteSubSubCategoryAdapter.SubSubCatOnItemClickListener;
...
public class FilterCategoryDialogFragment extends BaseFragment implements OnClickListener {
	...
	private void addSubSubCategoryArray(int catPos, int subCatPos) {
		...
		adapter.setOnItemClickListener(new SubSubCatOnItemClickListener() {
	...
	private void addSubCategoryArray(final int catPos) {
		...
		recyclerView.setAdapter(adapter);
		adapter.setOnItemClickListener(new SubCatOnItemClickListener() {
