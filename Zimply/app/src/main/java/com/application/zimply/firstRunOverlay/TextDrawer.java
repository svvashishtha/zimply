...
//        titlePaint.setTypeface(CommonLib.getTypeface(this.context, CommonLib.Bold));

        textPaint = new TextPaint();
        textPaint.setAntiAlias(true);
//        textPaint.setTypeface(CommonLib.getTypeface(this.context, CommonLib.Bold));
