...
public class MenuAdapter extends BaseAdapter {
    ...
    private int[] mainIcons = {R.drawable.ic_location_blue, R.drawable.ic_booking_green,R.drawable.order_history_orange,R.drawable.ic_fav_menu,  R.drawable.ic_feedback, R.drawable.ic_settings, R.drawable.ic_share_menu, R.drawable.ic_action_support,R.drawable.ic_rate_us,  R.drawable.ic_aboutus, R.drawable.ic_logout};
