...
public class MenuAdapter extends BaseAdapter {
    ...
    private int[] mainIcons = {R.drawable.ic_location_nav_drawer, R.drawable.ic_fav,R.drawable.order_history,R.drawable.ic_wishlist,  R.drawable.ic_feedback, R.drawable.ic_settings, R.drawable.ic_action_support,R.drawable.ic_rate_us,  R.drawable.ic_aboutus, R.drawable.ic_logout};
