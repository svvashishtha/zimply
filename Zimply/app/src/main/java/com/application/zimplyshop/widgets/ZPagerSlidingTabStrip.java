...
public class ZPagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int indicatorColor = getResources().getColor(
            R.color.z_indicator_color);
    ...
    private int tabBackgroundResId = R.drawable.z_tab_bg;
    ...
    public ZPagerSlidingTabStrip(Context context) {
        this(context, null);
    }

    public ZPagerSlidingTabStrip(Context context, AttributeSet attrs) {
    ...
    public ZPagerSlidingTabStrip(Context context, AttributeSet attrs,
        ...
        a = context.obtainStyledAttributes(attrs,
                R.styleable.ZPagerSlidingTabStrip);

        indicatorColor = a.getColor(
                R.styleable.ZPagerSlidingTabStrip_pstsIndicatorColor,
                indicatorColor);
        underlineColor = a.getColor(
                R.styleable.ZPagerSlidingTabStrip_pstsUnderlineColor,
                underlineColor);
        dividerColor = a.getColor(
                R.styleable.ZPagerSlidingTabStrip_pstsDividerColor,
                dividerColor);
        indicatorHeight = a.getDimensionPixelSize(
                R.styleable.ZPagerSlidingTabStrip_pstsIndicatorHeight,
                indicatorHeight);
        underlineHeight = a.getDimensionPixelSize(
                R.styleable.ZPagerSlidingTabStrip_pstsUnderlineHeight,
                underlineHeight);
        dividerPadding = a.getDimensionPixelSize(
                R.styleable.ZPagerSlidingTabStrip_pstsDividerPadding,
                dividerPadding);
        tabPadding = a.getDimensionPixelSize(
                R.styleable.ZPagerSlidingTabStrip_pstsTabPaddingLeftRight,
                tabPadding);
        tabBackgroundResId = a.getResourceId(
                R.styleable.ZPagerSlidingTabStrip_pstsTabBackground,
                tabBackgroundResId);
        shouldExpand = a.getBoolean(
                R.styleable.ZPagerSlidingTabStrip_pstsShouldExpand,
                shouldExpand);
        scrollOffset = a.getDimensionPixelSize(
                R.styleable.ZPagerSlidingTabStrip_pstsScrollOffset,
                scrollOffset);
        textAllCaps = a.getBoolean(
                R.styleable.ZPagerSlidingTabStrip_pstsTextAllCaps, textAllCaps);
        tabSwitch = a.getBoolean(
                R.styleable.ZPagerSlidingTabStrip_pstsTabSwitch, tabSwitch);
        tabTextColor = a.getColor(
                R.styleable.ZPagerSlidingTabStrip_pstsActivateTextColor,
                tabTextColor);
        tabDeactivateTextColor = a.getColor(
                R.styleable.ZPagerSlidingTabStrip_pstsDeactivateTextColor,
    ...
    public void changeTabIcon(int drawable) {
    ...
    public void setDeactivateTextColor(int deactivateTextColor) {
       ...
       /* this.tabDeactivateTextColor = getResources().getColor(
                deactivateTextColor);*/
        updateTabStyles();
    }
